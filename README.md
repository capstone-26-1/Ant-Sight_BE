...
# Stock Data Crawling & Processing Pipeline

A scalable data pipeline system that collects, processes, and stores large-scale stock discussion data from Naver Finance.

## Overview

My position is designed to handle large-scale data collection and processing by integrating a web crawler, data cleaning pipeline, and backend API server.
